...
module cnn_small_core (
    ...
    localparam IDLE=5'd0,
               C1A=5'd1, C1M=5'd2, C1S=5'd3,
               P1A=5'd4, P1R0=5'd5, P1R1=5'd6, P1R2=5'd7, P1R3=5'd8, P1S=5'd9,
               C2A=5'd10, C2M=5'd11, C2S=5'd12,
               P2A=5'd13, P2R0=5'd14, P2R1=5'd15, P2R2=5'd16, P2R3=5'd17, P2S=5'd18,
               FCA=5'd19, FCM=5'd20, FCS=5'd21,
               ARG=5'd22, FIN=5'd23;
